...
{
  Serial.print (F("Nodes ")); if (teston) Serial.print (F("CAN TEST")); Serial.println (F(":"));
  for (int  i = 0 ; i < NODES_QUANTITY; i++ )
  {
    if ((teston && i!=INCOGNITO && i!=BROADCAST)||!teston)
    {
      if (teston){
